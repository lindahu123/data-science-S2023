...
- Does your interval include the true value of $\pi$?
  - Yes, the true of value of pi does lie within the interval
- What confidence level did you choose?
  - 95% confidence level
- Was your sample size $n$ large enough? Why do you say that?
  - I believe that the sample size of n = 5000 that I choose is large
    enough, because pi lies within the range, and the standard error is
    very small.
