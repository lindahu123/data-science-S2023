...
```
    ...
    ## # A tibble: 26 × 5
    ##    thick alloy   angle    nu     E
    ##    <dbl> <chr>   <int> <dbl> <dbl>
    ##  1 0.022 al_24st     0 0.321 10600
    ##  2 0.022 al_24st    45 0.329 10700
    ##  3 0.022 al_24st    90 0.31  10500
    ##  4 0.022 al_24st     0 0.323 10600
    ##  5 0.022 al_24st    45 0.331 10500
    ##  6 0.022 al_24st    90 0.323 10700
    ##  7 0.032 al_24st     0 0.329 10400
    ##  8 0.032 al_24st    45 0.318 10400
    ##  9 0.032 al_24st    90 0.322 10300
    ## 10 0.032 al_24st     0 0.319 10300
    ## # … with 16 more rows
...
- Is there “one true value” for the material properties of Aluminum?
  - It looks like from the data, the values for E and nu differ slightly
    at different angles, but from looking at a table of mean values, it
    looks like angle and thickness don’t clearly impact the material
    properties
...
-Does thickness affect E? -From looking at the table, it seems that the
smallest thickness has the highest E, while the largest thickness has
the smallest value for E. It would be intersting to take a closer look
into whether there is an actual correlation between these parameters.
...
- Does this graph support or contradict the claim above? The graph does
  not seem to contradict the claim above. The E values for 0.032 and
  0.064 are almost exactly the same, despite one thickness being double
  the other one. It is notable that the values for 0.081 are much lower
  than the others, both for E and poisson’s ratio. I wonder if the 0.081
  sample was formed a different way or if it is a slightly different
  alloy.
