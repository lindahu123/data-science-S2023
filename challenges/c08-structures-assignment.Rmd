...
-   To what extent can you tell what shape the distribution of the data has?
    -   From this limited bin size/sample size, it appears to follow a normal distribution
...
-   Is this estimate of the probability of failure trustworthy? Why or why not?
    -   This estimate of failure does not seem trustworthy due to the limited sample size
-   Can you confidently conclude that `POF < 0.03`? Why or why not.
    -   No, due to the limited sample size I am not confident in this conclusion
...
-   Assuming your scopus is the probability of failure `POF` defined above, does your estimate exhibit real variability, induced variability, or both?
    ...
    -   both. induced variability could could from manufacturing defects. real variability could come from the process with rlnorm
...
-   Does the confidence interval above account for uncertainty arising from *limited physical tests* (`df_samples`)? Why or why not?
    ...
    -   no,we have accepted the limited physical tests and assumed other strengths measured would follow a normal distribution
...
-   Can you *confidently* conclude that `POF < 0.03`? Why or why not?
    ...
    -   Although we can't be 100% sure, we are fairly confident that this is true due to the 95% confidence interval
...
-   Does this estimate have any uncertainty due to *limited physical tests*? Why or why not?
    -   yes, the method still is drawing from the very limited sample of physical tests
-   With the scopus as the `POF`, would uncertainty due to *limited physical tests* be induced or real?
    -   both. induced variability could could from manufacturing defects. real variability could come from the random uncontrollable aspects such as the way in which the aluminum forms
...
-   Does the confidence interval above account for uncertainty arising from *limited physical tests* (`df_samples`)? Why or why not?
    -   no, it accounts for uncertainty arrising from plnorm and now defects n the given sample
-   Can you confidently conclude that `POF < 0.03`? Why or why not?
    -   No, because the probility of 0.03 lies within the confidence interval
