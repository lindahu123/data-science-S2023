...
-   To what extent can you tell what shape the distribution of the data has?
    -   From this limited sample size, there is not enough of a pattern to determine whether this data follows a normal distribution.
...
-   Assuming your scopus is the probability of failure `POF` defined above, does your estimate exhibit real variability, induced variability, or both?
    ...
    -   There should just be induced variability. For there to be real variability in the POF, the underlying distribution would need to be changing which is not likely in this scenario
...
-   Can you *confidently* conclude that `POF < 0.03`? Why or why not?
    ...
    -   No, we cannot confidently conclude that because of the limited physical tests
